    ...
    <div className="relative z-[60] pointer-events-auto">
      {!collapsed ? (
        ...
        <button
          ...
          className="absolute top-2 left-2 sm:top-4 sm:left-4 flex items-center gap-1 sm:gap-2 px-2 sm:px-3 py-1.5 sm:py-2 bg-white/90 backdrop-blur rounded-full shadow-md border border-gray-200 hover:shadow-lg transition-all"
          title="展开位置输入"
        >
