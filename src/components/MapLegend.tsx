export const MapLegend = () => {
  return (
    <div className="absolute bottom-2 left-2 sm:bottom-4 sm:left-4 bg-white/95 backdrop-blur rounded-lg shadow-lg border border-gray-200 px-2 sm:px-3 py-1 sm:py-2 z-50">
