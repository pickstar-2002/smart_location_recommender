      ...
      <div className="w-full h-[calc(100vh-4rem)]">
        ...
        <div className="flex flex-col lg:flex-row h-full">
          ...
          {!searchPanelCollapsed && (
            <div className="w-full lg:w-96 xl:w-[28rem] bg-white border-l-0 lg:border-l border-gray-200 shadow-lg order-2 lg:order-2 max-h-[50vh] lg:max-h-none relative">
              <div className="h-full flex flex-col">
                <div className="flex items-center justify-between px-4 py-2 border-b border-gray-200">
                  <h3 className="text-sm sm:text-base font-semibold text-gray-800 flex items-center">
                    <img src="/favicon.png" alt="search" className="w-4 h-4 sm:w-5 sm:h-5 mr-2" />
                    位置搜索
                  </h3>
                  <button
